...
class AppTheme {
  ...
  static TextStyle get buttonTextStyle =>
      const TextStyle(fontWeight: FontWeight.w500, fontFamily: 'Barlow');
  ...
  static SnackBar customSnackbar(String message) {
    return SnackBar(
      content: Text(message, style: AppTheme.normalTextStyle),
...
class ResultTextBlock extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Text(title, overflow: TextOverflow.clip, style: AppTheme.h3),
        Text(
          content,
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: InkWell(
        ...
        child: ListTile(
          title: Text(title, style: AppTheme.normalTextStyle),
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: InkWell(
        ...
        borderRadius: BorderRadius.circular(10),
        child: ListTile(
          title: Text(title, style: textStyle ?? AppTheme.normalTextStyle),
        ),
      ),
    );
  }
...
class CustomSettingSwitchCard extends CustomSettingCard {
  ...
  Widget build(BuildContext context) {
    ...
    Color finalInactiveThumbColor =
        inactiveThumbColor ?? AppTheme.backgroundColour;
    Color finalInactiveTrackColor =
