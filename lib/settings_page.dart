...
class SharedPrefs {
  ...
  String get customSearchName =>
      _sharedPrefs?.getString('customSearchName') ?? "Findit@Flinders";
  set customSearchName(String value) =>
      _sharedPrefs?.setString('customSearchName', value);

  String get customSearchDomain =>
      _sharedPrefs?.getString('customSearchDomain') ??
  ...
  set customSearchDomain(String value) =>
      _sharedPrefs?.setString('customSearchDomain', value);
...
class _SettingsPageState extends State<SettingsPage> {
  ...
  Future<void> initializeSharedPreferences() async {
    ...
    setState(() {
      ...
      customSearchName =
          sharedPreferences.getString('customSearchName') ?? "Findit@Flinders";
      customSearchDomain =
          sharedPreferences.getString('customSearchDomain') ??
          "https://flinders.primo.exlibrisgroup.com/discovery/search?query=any,contains,[isbn]&vid=61FUL_INST:FUL&tab=Everything&facet=rtype,exclude,reviews";
    });
  }
            ...
            children: [
              Padding(
                ...
                child: Container(
                  ...
                  child: Text('Settings', style: AppTheme.h1),
                ),
              ),
                  ...
                  showDialog(
                    ...
                    builder: (BuildContext context) {
                      final TextEditingController siteNameController =
                          TextEditingController(text: customSearchName);
                      final TextEditingController siteLinkController =
                          TextEditingController(text: customSearchDomain);

                      return StatefulBuilder(
                        builder: (BuildContext context, StateSetter setState) {
                          bool areFieldsNotEmpty =
                              siteNameController.text.isNotEmpty &&
                              siteLinkController.text.isNotEmpty;
                              ...
                              child: AlertDialog(
                                ...
                                actions: <Widget>[
                                  ...
                                  ElevatedButton(
                                    ...
                                    onPressed: areFieldsNotEmpty
                                        ? () async {
                                            String siteName =
                                                siteNameController.text;
                                            String siteLink =
                                                siteLinkController.text;
    ...
    try {
      if (await Permission.storage.request().isGranted) {
        ...
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(AppTheme.customSnackbar('File exported successfully'));
      } else {
